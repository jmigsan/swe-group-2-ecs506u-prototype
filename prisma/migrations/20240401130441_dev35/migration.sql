/*
  ...
  - You are about to alter the column `AmountBought` on the `Trade` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Decimal`.
  - You are about to alter the column `AmountSold` on the `Trade` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Decimal`.
  - You are about to alter the column `Price` on the `Trade` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Decimal`.
  - You are about to alter the column `amount` on the `Balance` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Decimal`.
